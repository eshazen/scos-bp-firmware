...
*******************************************************************************/
(* ORIG_MODULE_NAME="main_pll", LATTICE_IP_GENERATED="1" *) module main_pll (clki_i, 
        clkop_o, 
        lock_o) ;
    input clki_i ; 
    output clkop_o ; 
        ...
        if ((APB_EN == 1)) 
            begin : gen_apb
                ...
                if (APB_SOFT_REG_EN) 
                    begin : gen_csr
                        wire unused_w ; 
                        main_pll_ipgen_pll_csr u_csr (// Inputs
                                .clk_i(apb_pclk_i), 
                                    .rst_n_i(apb_preset_n_i), 
...
// Module : pll_csr
//==========================================================================
(* LATTICE_IP_MODULE=1 *) module main_pll_ipgen_pll_csr #(parameter SIMULATION = 0) (
    //--begin_param--
    //----------------------------
    // Parameters
    //----------------------------
