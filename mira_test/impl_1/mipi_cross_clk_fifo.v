...
// Netlist written on Wed Jul 29 23:22:33 2026
...
//
// Verilog Description of module mipi_cross_clk_fifo
...
module mipi_cross_clk_fifo (wr_clk_i, rd_clk_i, rst_i, rp_rst_i, wr_en_i, 
            rd_en_i, wr_data_i, full_o, empty_o, rd_data_o) /* synthesis ORIG_MODULE_NAME="mipi_cross_clk_fifo", LATTICE_IP_GENERATED="1", cpe_box=1 */ ;
    input wr_clk_i;
    input rd_clk_i;
    input rst_i;
    input rp_rst_i;
