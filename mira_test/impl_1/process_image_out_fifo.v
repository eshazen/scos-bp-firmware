...
// Netlist written on Wed Jul 29 23:22:34 2026
...
//
// Verilog Description of module process_image_out_fifo
...
module process_image_out_fifo (clk_i, rst_i, wr_en_i, rd_en_i, wr_data_i, 
            full_o, empty_o, almost_full_o, almost_empty_o, rd_data_o) /* synthesis ORIG_MODULE_NAME="process_image_out_fifo", LATTICE_IP_GENERATED="1", cpe_box=1 */ ;
    input clk_i;
    input rst_i;
    input wr_en_i;
    input rd_en_i;
