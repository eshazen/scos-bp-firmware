...
architecture architecture_mipi_rx of mipi_rx is
  ...
  signal FifoPDatxDP, FifoPDatxDN       : std_logic_vector(31 downto 0);  -- 32 bit data working
  signal FifoSyncxSP, FifoSyncxSN       : std_logic_vector(1 downto 0);   -- 32 bit sync working
  signal FifoPDatPrexDP, FifoPDatPrexDN : std_logic_vector(31 downto 0);  -- 32 bit data register
  signal FifoSyncPrexSP, FifoSyncPrexSN : std_logic_vector(1 downto 0);   -- sync register
