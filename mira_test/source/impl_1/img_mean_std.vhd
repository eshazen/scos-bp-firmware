...
begin
  ...
  SumOutxDN <= to_unsigned(16#fffe#, SumOutxDN'length) when TxHeaderxS = '1'
               else SumMemxDP(RdAddrxDP);
  SumSqOutxDN <= to_unsigned(16#ffff#, SumSqOutxDN'length) when TxHeaderxS = '1'
                 else SumSqMemxDP(RdAddrxDP);
  SumOutValidxSN <= '1' when TxHeaderxS = '1' or SumMemRdEnxSP = '1'
                    else '0';
